...
2. miniconda: https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/
...
curl -O https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/Miniconda3-py313_26.1.1-1-Linux-x86_64.sh
```
